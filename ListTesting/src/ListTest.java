...
public class ListTest 
{
	...
	{
		//run tests - description of test case, method testing, list tested, arguments to method tested, expected result
		printTest("twoElementList_addAfterFirstElement_testRemoveFirst", testRemoveFirst(newList(Methods.addAfter, 2, A, B, C, A), Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testRemoveLast", testRemoveLast(newList(Methods.addAfter, 2, A, B, C, A), Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testaddToFront_D", testAddToFront(newList(Methods.addAfter, 2, A, B, C, A), D, Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testaddToRear_D", testAddToRear(newList(Methods.addAfter, 2, A, B, C, A), D, Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testRemove_A", testRemove(newList(Methods.addAfter, 2, A, B, C, A), A, Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testRemove_B", testRemove(newList(Methods.addAfter, 2, A, B, C, A), B, Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testRemove_C", testRemove(newList(Methods.addAfter, 2, A, B, C, A), C, Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testFirst", testFirst(newList(Methods.addAfter, 2, A, B, C, A), Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testLast", testLast(newList(Methods.addAfter, 2, A, B, C, A), Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testContains_A", testContains(newList(Methods.addAfter, 2, A, B, C, A), A, Results.True));
		printTest("twoElementList_addAfterFirstElement_testContains_B", testContains(newList(Methods.addAfter, 2, A, B, C, A), B, Results.True));
		printTest("twoElementList_addAfterFirstElement_testIsEmpty", testIsEmpty(newList(Methods.addAfter, 2, A, B, C, A), Results.False));
		printTest("twoElementList_addAfterFirstElement_testSize", testSize(newList(Methods.addAfter, 2, A, B, C, A), 3));
		printTest("twoElementList_addAfterFirstElement_testIterator", testIterator(newList(Methods.addAfter, 2, A, B, C, A), Results.NoException));
		printTest("twoElementList_addAfterFirstElement_testToString", testToString(newList(Methods.addAfter, 2, A, B, C, A), Results.NoException));
	}
	...
	{
		//run tests - description of test case, method testing, list tested, arguments to method tested, expected result
		printTest("twoElementList_addAfterSecondElement_testRemoveFirst", testRemoveFirst(newList(Methods.addAfter, 2, A, B, C, B), Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testRemoveLast", testRemoveLast(newList(Methods.addAfter, 2, A, B, C, B), Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testaddToFront_D", testAddToFront(newList(Methods.addAfter, 2, A, B, C, B), D, Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testaddToRear_D", testAddToRear(newList(Methods.addAfter, 2, A, B, C, B), D, Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testRemove_A", testRemove(newList(Methods.addAfter, 2, A, B, C, B), A, Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testRemove_B", testRemove(newList(Methods.addAfter, 2, A, B, C, B), B, Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testRemove_C", testRemove(newList(Methods.addAfter, 2, A, B, C, B), C, Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testFirst", testFirst(newList(Methods.addAfter, 2, A, B, C, B), Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testLast", testLast(newList(Methods.addAfter, 2, A, B, C, B), Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testContains_A", testContains(newList(Methods.addAfter, 2, A, B, C, B), A, Results.True));
		printTest("twoElementList_addAfterSecondElement_testContains_B", testContains(newList(Methods.addAfter, 2, A, B, C, B), B, Results.True));
		printTest("twoElementList_addAfterSecondElement_testIsEmpty", testIsEmpty(newList(Methods.addAfter, 2, A, B, C, B), Results.False));
		printTest("twoElementList_addAfterSecondElement_testSize", testSize(newList(Methods.addAfter, 2, A, B, C, B), 3));
		printTest("twoElementList_addAfterSecondElement_testIterator", testIterator(newList(Methods.addAfter, 2, A, B, C, B), Results.NoException));
		printTest("twoElementList_addAfterSecondElement_testToString", testToString(newList(Methods.addAfter, 2, A, B, C, B), Results.NoException));
